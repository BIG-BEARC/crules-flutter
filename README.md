...
> **当前状态：1.0.1 docs 清账**——15 篇已吸收过程文档删除（3408→237 行，活引用 3 处随删改指）；1.0.0 独立成库（斩断母版 crules 联系，deny-list Vendor 终态）；此前 0.6.3-0.6.8 留池收口 + 实战复盘四批吸收 + 语义闸 17 断言；常驻基线 14.4K（距 15K 线 0.6K，归因口径见维护节）。
